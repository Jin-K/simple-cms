...
using SimpleCMS.Auth.Models.AccountViewModels;
...
namespace SimpleCMS.Auth.Controllers {
	public class AccountController : Controller {
		...
		public async Task<IActionResult> Login(string returnUrl = null) {
			...
			ViewData["Origin"] = _identityServerConfiguration.Origin;
			ViewData["AllowedCorsOrigins"] = _identityServerConfiguration.AllowedCorsOrigins;
			return View();
		}
