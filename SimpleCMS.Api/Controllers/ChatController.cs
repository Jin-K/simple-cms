...
namespace SimpleCMS.Api.Controllers {
	...
	public class ChatController : ControllerBase {
		...
		public IActionResult PostChats(string id, [FromBody] dynamic rawChat) {
			...
			// get list of chats or return rawChat
			if (!(FakeDb.Chats is List<dynamic> chats)) return Ok(rawChat);
		...
		public IActionResult PostUser(string id, [FromBody] dynamic rawUserData) {
			...
			// get list of users and update data in fake db
			if (FakeDb.User is List<dynamic> users) users[0] = rawUserData;
