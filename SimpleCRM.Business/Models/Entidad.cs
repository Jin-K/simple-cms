...
namespace SimpleCRM.Business.Models {
  ...
  public struct Item {
    ...
    /// <summary>
    /// Static method to transforms a IEntidad typed entity item to a Item typed strucure
    /// </summary>
    /// <param name="item">original entity item</param>
    /// <returns>returns the created Item</returns>
    public static Item FromEntidad(IEntidad item, bool starred) => new Item { Id = item.Id, Active = true, Created = item.Created, Starred = starred };
